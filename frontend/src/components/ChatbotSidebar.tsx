  ...
  return (
    <>
      ...
      >
                      ...
                      >
                        {isEditing ? (
                          ...
                          <div
                            ...
                            className={`flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors duration-150 cursor-pointer ${activeSessionId === session.id
                              ? 'font-medium'
                              : ''
                              }`}
                            style={{
        ...
        {/* Branding Verification Footer - Privacy & Terms */}
        <div className="px-4 py-3 border-t border-gray-100 bg-gray-50/50">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            <a
              href="/privacy-policy"
              className="text-[10px] text-gray-500 hover:text-gray-700 hover:underline transition-colors"
            >
              Privacy Policy
            </a>
            <a
          ...
          <div className="mt-1">
            <p className="text-[10px] text-gray-400">© 2026 Prakriti AI Assistant</p>
          </div>
        </div>
