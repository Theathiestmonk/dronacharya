...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gray-50 chat-grid-bg">
      <main className="min-h-screen overflow-y-auto">
        {/* Back to Dashboard Button */}
        <div className="max-w-6xl mx-auto px-4 md:px-8 pt-6 md:pt-8">
          <Link
            href="/"
            className="inline-flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors font-medium mb-4"
          >
        ...
        <div className="max-w-5xl mx-auto p-3 md:p-6 py-0 md:py-4">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-8 text-gray-900 text-justify">
            <h1 className="text-base md:text-lg lg:text-xl font-bold mb-4 text-center md:text-left">Privacy Policy for Prakriti Chatbot</h1>
            <p className="mb-3 text-sm text-gray-600 text-center md:text-left">Last Updated: January 29, 2026</p>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">1. Information We Collect</h2>

            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">1.1 Personal Information</h3>
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">1.2 Automatically Collected Information</h3>
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">1.3 Third-Party Integrations</h3>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">2. Google API Data Disclosure</h2>
            <p className="mb-3 font-medium text-blue-800 bg-blue-50 p-3 rounded-md border border-blue-100">
              Prakriti AI Assistant&apos;s use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" className="underline">Google API Service User Data Policy</a>, including the Limited Use requirements.
            </p>

            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">2.1 Google Drive Access</h3>
            <p className="mb-3">
              Our Service requests <strong>readonly access to your Google Drive files</strong>. This permission is used exclusively to allow you to select and view your educational documents within the chatbot interface for support, feedback, and study purposes. We do not modify, delete, or share your Drive files with third parties.
            </p>

            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">2.2 Google Classroom Access</h3>
            <p className="mb-3">
              We access your <strong>Google Classroom coursework, assignments, and grades</strong> to provide personalized learning support. This data allows the AI to provide context-aware help based on your specific school tasks.
            </p>

            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">3. How We Use Your Information</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">3. Information Sharing and Disclosure</h2>

            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">3.1 Educational Sharing</h3>
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">3.2 Service Providers</h3>
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">3.3 Legal Requirements</h3>
            <p className="mb-4">
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">3.4 No Sale of Personal Information</h3>
            <p className="mb-4">
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">4. Data Security</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">5. Children&apos;s Privacy (COPPA Compliance)</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">6. Data Retention</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">7. Your Rights and Choices</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">8. Cookies and Tracking Technologies</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">9. International Data Transfers</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">10. Third-Party Links and Services</h2>

            <p className="mb-4">
              Our chatbot may provide links to third-party websites or integrate with external services. This Privacy Policy does not apply to these external services. We encourage you to review the privacy policies of any third-party services you use.
            </p>

            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">11. Changes to This Privacy Policy</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">12. Contact Us</h2>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <p className="mb-2">Website: <a href="https://prakriti.edu.in" className="text-blue-600 hover:text-blue-800 underline">https://prakriti.edu.in</a></p>
