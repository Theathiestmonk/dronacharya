...
const AppContent: React.FC<{ 
  ...
  return (
    <div className="min-h-screen h-screen flex flex-col bg-white dark:bg-gray-900 overflow-hidden">
      <ChatGPTLayout onLoginRedirect={handleLoginRedirect}>
        <main className="flex-1 flex items-center justify-center px-2 sm:px-4 md:px-6 lg:px-8 overflow-hidden">
