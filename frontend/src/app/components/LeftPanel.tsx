...
const LeftPanel: React.FC<LeftPanelProps> = ({ onLogoClick }) => {
  ...
  <aside className="flex flex-col items-center w-20 bg-white border-r border-gray-200 h-screen py-6 shadow-lg">
    ...
    <div className="mb-6">
      ...
      >
        <Image src="/prakriti_logo.webp" alt="Prakriti Visual" width={50} height={50} style={{ maxWidth: '50px', height: 'auto' }} />
      </button>
    </div>
    {/* User profile circle */}
    <div className="mb-8">
