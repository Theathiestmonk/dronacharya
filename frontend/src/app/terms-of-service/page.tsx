      ...
      <main className="min-h-screen overflow-y-auto">
        ...
        <div className="max-w-5xl mx-auto p-3 md:p-6 py-0 md:py-4">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-8 text-gray-900 text-justify">
            <h1 className="text-base md:text-lg lg:text-xl font-bold mb-4 text-center md:text-left">Terms of Service for Prakriti Chatbot</h1>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">1. Service Description</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">2. Eligibility and User Accounts</h2>

            <h3 className="text-sm md:text-base lg:text-lg font-medium mt-5 mb-2">2.1 Eligibility Requirements</h3>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">3. Acceptable Use Policy</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">4. AI Limitations and Disclaimers</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">5. Educational Content and Academic Integrity</h2>
            ...
            <h3 className="text-xl font-medium mt-6 mb-3">5.3 Google Classroom and Drive Integration</h3>
            <p className="mb-3">
              When integrating with Google Classroom or Google Drive, you authorize us to access your educational data (assignments, coursework, and readonly file access) as necessary to provide our tutoring and administrative services. This integration is subject to Google&apos;s Terms of Service and Privacy Policy. Our use of information received from Google APIs adheres to the Google API Service User Data Policy, including the Limited Use requirements.
            </p>

            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">6. Intellectual Property Rights</h2>
            ...
            <p className="mb-3">
              Our Service may integrate with or display content from third parties, including web resources. Such content is subject to the respective third parties&apos; terms of service and intellectual property rights.
            </p>

            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">7. Privacy and Data Protection</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">8. Termination and Suspension</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">9. Disclaimers and Limitation of Liability</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">10. Indemnification</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">11. Modifications to Terms</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">12. Governing Law and Dispute Resolution</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">13. Severability</h2>

            <p className="mb-3">
              If any provision of these Terms is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that the Terms will otherwise remain in full force and effect.
            </p>

            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">14. Entire Agreement</h2>
            ...
            <h2 className="text-base md:text-lg lg:text-xl font-semibold mt-6 mb-3">15. Contact Information</h2>
